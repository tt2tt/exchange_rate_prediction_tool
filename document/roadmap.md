...
## フェーズ0: 初期セットアップ
- [ ] README.mdを作成してプロジェクト概要・利用方法を整理
- [ ] クラス設計を作成し、`document/architecture/class_design.puml`で管理
...
- [ ] `document/progress.txt`に進捗記録フォーマットを準備

## フェーズ1: データハンドリングと前処理
- [ ] 必須カラム検証・欠損値/無限値処理を実装
- [ ] Date昇順ソート・ラグ適用の前処理パイプラインを実装
- [ ] 特徴量生成（リターン、乖離率、傾き、クロス、ボラティリティ）モジュールを作成

## フェーズ2: モデル学習と評価
- [ ] ロジスティック回帰モデル学習フローを構築
...
## フェーズ3: PySide6 UI構築
- [ ] UIモックを作成し、ファイル選択・数値入力・実行ボタンを配置
